...
const products = [
  {
    ...
    description: "Add, edit, and delete vehicle details",
    href: "/vehicle",
    icon: ChartPieIcon,
  },
  {
    name: "Vehicle Identification",
    description: "VIN (Vehicle Identification Number) validation",
    href: "#",
    icon: CursorArrowRaysIcon,
  },
  {
    name: "Vehicle Health Check",
    description: "Maintenance schedules and alerts",
    href: "#",
...
const users = [
  {
    ...
    description: "Add, edit, and delete user details",
    href: "#",
    icon: ChartPieIcon,
  },
  {
      ...
      >
        <div className="flex lg:flex-1">
          <NavLink to="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Telematics System</span>
            <img
              alt=""
